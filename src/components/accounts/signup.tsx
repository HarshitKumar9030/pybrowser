      ...
      try {
        ...
        if (signInResponse?.ok) {
          toast({
            ...
            variant: "default", 
            className: "border border-blue-600 shadow-lg", 
          });
          router.replace('/'); 
        }
      } catch (error) {
  ...
  return (
    <div className="flex items-center py-8 justify-center min-h-screen bg-gradient-to-br from-neutral-100 via-neutral-200 to-neutral-300 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-700 text-neutral-900 dark:text-neutral-100">
      <div className="relative flex max-w-4xl w-full rounded-xl overflow-hidden shadow-xl bg-white dark:bg-neutral-900">
        <div className="hidden lg:flex flex-col justify-center items-center p-8 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
          <Image
            src="/login.svg"
        ...
        >
          <h1 className="text-3xl font-bold mb-6">Create an Account for PyBrowser</h1>
          {error && (
            <motion.div
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                name="name"
                required
              />
            </div>
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-2 py-3 bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 rounded-lg hover:bg-gray-200 dark:hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
